...
public class MenuTestDrive {
    ...
    public static void main(String[] args) {
        MenuComponent pancakeHouseMenu = new Menu("PANCAKE HOSE MENU", "Breakfast");
        ...
        dinerMenu.add(new MenuItem("Soup ot the day", "Soup of the day, with a side of potato salad", false, 3.29));
        ...
        cafeMenu.add(new MenuItem("Burrito", "A large burrito, with whole pinto beans, salsa, guacamole", true, 3.99));
        // pancake house menu
