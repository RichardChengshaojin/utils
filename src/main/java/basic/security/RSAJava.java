...
import utils.common.NumberUtils;
...
public class RSAJava {
    ...
    public void testRSA() throws NoSuchAlgorithmException {
        ...
        System.out.println(NumberUtils.bytesToHex(rsaPublicKeyEncoded));
        System.out.println(NumberUtils.bytesToHex(rsaPirvateKeyEncoded));
